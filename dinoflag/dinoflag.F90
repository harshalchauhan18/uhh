...
!-----------------------------------------------------------------------
  ...
  namelist /uhh_dinoflag/ mumax,vmort,     &
   ...
   call self%register_diagnostic_variable(self%id_meanres_diag, 'res_vertmean','mmol n/m**3','vertical mean resting biomass')
...
!      'light limitation factor', output=output_instantaneous)
   call self%register_diagnostic_variable(self%id_tmat,'tmat','d', &
      'maturation time', output=output_instantaneous)
